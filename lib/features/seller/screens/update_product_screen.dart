...
class _AddProductScreenState extends State<UpdateProductScreen> {
  ...
  void updateProduct() async {
    ...
    if (_addProductFormKey.currentState!.validate()) {
      ...
      final hasChanges = productNameController.text.isNotEmpty ||
      ...
      if (hasChanges) {
        ...
        final isSuccess = await sellerServices.updateProduct(
          context: context,
            ...
            child: Column(
              children: [
                ...
                CustomTextField(
                  ...
                  validator: (value) {
                    // This field is optional for update, so no validation needed if empty
                    return null;
                  },
                ),
                const SizedBox(height: 10),
