...
class OrderServices {
  ...
  void cancelOrder({
    ...
    try {
      http.Response res = await http.post(
        Uri.parse('$uri/api/orders/cancel/$orderId'),
        headers: {
  ...
  void cancelOrderSeller({
    ...
    try {
      http.Response res = await http.post(
        Uri.parse('$uri/seller/orders/cancel/$orderId'),
        headers: {
          'Content-Type': 'application/json; charset=UTF-8',
          'x-auth-token': userProvider.user.token,
        },
  ...
  // Delete order for seller
  void deleteOrderSeller({
    required BuildContext context,
    required String orderId,
    required VoidCallback onSuccess,
  }) async {
    ...
    try {
      http.Response res = await http.delete(
        Uri.parse('$uri/seller/orders/$orderId'),
        headers: {
          'Content-Type': 'application/json; charset=UTF-8',
          'x-auth-token': userProvider.user.token,
        },
