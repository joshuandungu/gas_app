...
const MPESA_CALLBACK_URL = process.env.MPESA_CALLBACK_URL || "https://gas-app-backend-1gjx.onrender.com/api/mpesa/callback.js";
...
mpesaRouter.post("/api/mpesa/transaction-status/:orderId", auth, async (req, res) => {
    ...
    try {
        ...
        const payload = {
            ...
            // IMPORTANT: SecurityCredential must be generated by encrypting your Daraja security password
            // with the Safaricom public key (from Daraja portal) and base64 encoding the result.
            // This value MUST be provided via env var in production: MPESA_SECURITY_CREDENTIAL
