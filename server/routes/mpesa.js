...
const MPESA_CONSUMER_KEY = process.env.MPESA_CONSUMER_KEY || "yourConsumerKey";
const MPESA_CONSUMER_SECRET = process.env.MPESA_CONSUMER_SECRET || "yourConsumerSecret";
const MPESA_SHORTCODE = process.env.MPESA_SHORTCODE || "174379"; // Paybill/Till
const MPESA_PASSKEY = process.env.MPESA_PASSKEY || "yourPassKey";
const MPESA_ENV = process.env.MPESA_ENV || "sandbox";

const MPESA_CALLBACK_URL = process.env.MPESA_CALLBACK_URL || "https://your-ngrok-url.ngrok-free.app/api/mpesa/callback";
...
mpesaRouter.post("/api/mpesa/stk-push", auth, async (req, res) => {
    ...
    if (amount < 1 || amount > 150000) {
        return res.status(400).json({ msg: "Amount must be between 1 and 150,000 KES." });
    }
